...
if __name__ == "__main__":
    ...
    val_parser.add_argument("--dataset", type=str, default="iseg2017", help="iseg2017 / task02_heart / task04_hippocampus / luna16")
    ...
    precision_metric = ConfusionMatrixMetric(include_background=False, metric_name='precision', compute_sample=True, reduction='none', get_not_nans=False)
    sensitivity_metric = ConfusionMatrixMetric(include_background=False, metric_name='sensitivity', compute_sample=True, reduction='none', get_not_nans=False)
